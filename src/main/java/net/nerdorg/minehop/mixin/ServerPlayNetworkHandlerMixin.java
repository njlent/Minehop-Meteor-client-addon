...
// import net.nerdorg.minehop.block.ModBlocks; // DISABLED - not needed for Meteor addon
import net.nerdorg.minehop.config.ConfigWrapper;
import net.nerdorg.minehop.config.MinehopConfig;
// import net.nerdorg.minehop.util.MovementUtil; // DISABLED - not needed for Meteor addon
