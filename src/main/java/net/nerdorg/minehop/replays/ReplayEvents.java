    ...
    public static void register() {
        ServerTickEvents.END_SERVER_TICK.register(((server) -> {
            for (ServerPlayerEntity playerEntity : server.getPlayerManager().getPlayerList()) {
                if (MinehopAddon.timerManager.containsKey(playerEntity.getNameForScoreboard())) {
                    if (replayEntryMap.containsKey(playerEntity.getNameForScoreboard())) {
                        ...
                        if (MinehopAddon.lastEfficiencyMap.containsKey(playerEntity.getNameForScoreboard())) {
                            ReplayManager.SSJEntry ssjEntry = (ReplayManager.SSJEntry)MinehopAddon.lastEfficiencyMap.get(playerEntity.getNameForScoreboard());
