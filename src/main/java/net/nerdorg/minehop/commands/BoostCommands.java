...
public class BoostCommands {
    ...
    private static void handleEditBooster(CommandContext<ServerCommandSource> context) {
        ...
        ServerWorld serverWorld = (ServerWorld) context.getSource().getWorld();
        BlockHitResult blockHitResult = serverWorld.raycast(clipContext);
        BlockPos hitPos = blockHitResult.getBlockPos();
        BlockEntity blockEntityAtHitPos = serverWorld.getBlockEntity(hitPos);
