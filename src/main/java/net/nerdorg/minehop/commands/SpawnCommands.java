...
public class SpawnCommands {
            ...
            if (!serverPlayerEntity.isSpectator()) {
                ...
                if (SpectateCommands.spectatorList.containsKey(serverPlayerEntity.getNameForScoreboard())) {
                    ...
                    for (String spectator : spectators) {
                        ...
                        spectatorPlayer.teleport(context.getSource().getServer().getOverworld(), serverPlayerEntity.getX(), serverPlayerEntity.getY(), serverPlayerEntity.getZ(), Set.of(), serverPlayerEntity.getYaw(), serverPlayerEntity.getPitch(), true);
    ...
    private static void removeSpawn(CommandContext<ServerCommandSource> context) {
        ...
        DataManager.MapData pairedMap = DataManager.getMap(name);
        if (pairedMap != null) {
            MinehopAddon.mapList.remove(pairedMap);
