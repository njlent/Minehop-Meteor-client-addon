...
public class SpectateCommands {
    ...
    private static void handleUnSpectate(CommandContext<ServerCommandSource> context) throws CommandSyntaxException {
        ...
        if (MinehopAddon.timerManager.containsKey(serverPlayerEntity.getNameForScoreboard())) {
        ...
        if (entity instanceof ReplayEntity replayEntity) {
            ...
            if (mapName != null) {
                if (replayName.startsWith(mapName)) {
                    ...
                    serverPlayerEntity.teleport(serverWorld, replayEntity.getX(), replayEntity.getY(), replayEntity.getZ(), Set.of(), replayEntity.getYaw(), replayEntity.getPitch(), true);
            ...
            if (playerEntity == serverPlayerEntity) {
                ...
                if (mapName.equals(targetMapName)) {
                    ...
                    serverPlayerEntity.teleport(serverWorld, playerEntity.getX(), playerEntity.getY(), playerEntity.getZ(), Set.of(), playerEntity.getYaw(), playerEntity.getPitch(), true);
